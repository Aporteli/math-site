  ...
  return (
    <>
      <button
        ...
        className="fixed right-5 bottom-5 z-40 inline-flex h-14 items-center gap-2 rounded-full bg-navy px-4 text-sm font-semibold text-white shadow-lg transition-colors hover:bg-navy-strong focus:outline-none focus:ring-2 focus:ring-navy/25 focus:ring-offset-2 focus:ring-offset-paper"
      >
        <MessageSquare className="size-5" aria-hidden="true" />
        <span className="hidden sm:inline">{copy.chat.launcher}</span>
      </button>
