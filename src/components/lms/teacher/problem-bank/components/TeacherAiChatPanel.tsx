...
export function TeacherAiChatPanel({
  ...
  const [assigningProblems, setAssigningProblems] = useState<
    { topic: string; promptTex: string; solutionTex: string }[]
  >([]);
  ...
  useEffect(() => {
    const rawList =
      initialImagesBase64.length > 0 ? initialImagesBase64 : initialImageBase64 ? [initialImageBase64] : [];
