//CUT
// ეს ფაილი აყალიბებს DashboardFrame კომპონენტს, რომელიც უზრუნველყოფს დეშბორდის გვერდის ლეიაუთს (ნავიგაცია, გვერდითი პანელი, თემის და ენის შეცვლა, მომხმარებლის ინფორმაცია). ასევე ამ კონტექსტში ინახება და მართავს sidebar-ის (გვერდითი პანელის) მდგომარეობას, მომხმარებლის როლს და შესაბამის ლეიბლებს, და განლაგებული კომპონენტების შიგთავსს.
